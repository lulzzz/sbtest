	...
	public class OnlinePayrollModelMapperProfile : ProfileLazy
	{
		...
		protected override void Configure()
		{
			...
			CreateMap<Models.Company, Models.DataModel.Company>()
				...
				.ForMember(dest => dest.CompanyProjects, opt => opt.Ignore())
			...
			CreateMap<Models.ContractDetails, Models.DataModel.CompanyContract>()
				...
				.ForMember(dest => dest.Options,
					opt => opt.MapFrom(src => JsonConvert.SerializeObject(src.Options)))
				.ForMember(dest => dest.InvoiceSetup,
			...
			CreateMap<Models.DataModel.CompanyProject, Models.CompanyProject>();
			CreateMap<Models.CompanyProject, Models.DataModel.CompanyProject>()
				.ForMember(dest => dest.Company, opt => opt.Ignore())
			...
			CreateMap<Models.Employee, Models.DataModel.Employee>()
				...
				.ForMember(dest => dest.PayTypeAccruals, opt => opt.MapFrom(src => JsonConvert.SerializeObject(src.PayTypeAccruals)))
			...
			CreateMap<Models.DataModel.Payroll, Models.Payroll>()
				...
				.ForMember(dest => dest.InvoiceId, opt => opt.MapFrom(src => src.PayrollInvoices.Any() ? src.PayrollInvoices.First().Id : default(Guid?)))
				...
				.ForMember(dest => dest.HasACH, opt => opt.Ignore())
				.ForMember(dest => dest.PayrollNo, opt => opt.Ignore())
				.ForMember(dest => dest.HasExtracts, opt => opt.Ignore())
			...
			CreateMap<Models.Payroll, Models.DataModel.Payroll>()
				...
				.ForMember(dest => dest.CompanyProject, opt => opt.Ignore());
			...
			CreateMap<Models.ExtractPayCheck, Models.PayCheck>()
				...
				.ForMember(dest => dest.VoidedBy, opt => opt.Ignore())
			...
			CreateMap<Models.MasterExtractDB, Models.MasterExtract>()
				...
				.ForMember(dest => dest.ConfirmationNo, opt => opt.Ignore())
				.ForMember(dest => dest.ConfirmationNoTS, opt => opt.Ignore())
				.ForMember(dest => dest.ConfirmationNoUser, opt => opt.Ignore())
				.ForMember(dest => dest.Id, opt => opt.Ignore())
				.ForMember(dest => dest.LastModified, opt => opt.Ignore())
				.ForMember(dest => dest.LastModifiedBy, opt => opt.Ignore())
