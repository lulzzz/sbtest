Alter table Common.Memento Add Comments varchar(max), UserId uniqueidentifier;

/****** Object:  StoredProcedure [dbo].[GetCompaniesNextPayrollChartData]    Script Date: 17/11/2016 6:30:51 PM ******/
