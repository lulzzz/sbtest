IF Not EXISTS(SELECT *
          ...
          WHERE  TABLE_NAME = 'Host'
                 AND COLUMN_NAME = 'BankCustomerId')
Alter table Host Add BankCustomerId varchar(max);

IF Not EXISTS(SELECT *
          FROM   INFORMATION_SCHEMA.COLUMNS
          WHERE  TABLE_NAME = 'Company'
                 AND COLUMN_NAME = 'ParentId')
Alter table Company Add ParentId uniqueidentifier;
...
/****** Object:  StoredProcedure [dbo].[GetExtractData]    Script Date: 21/12/2016 2:13:44 PM ******/
