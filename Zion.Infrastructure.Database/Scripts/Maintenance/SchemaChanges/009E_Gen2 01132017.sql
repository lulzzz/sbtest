...
update ACHTransaction set CompanyName=(select c.CompanyName from Company c, Employee e where c.Id=e.CompanyId and e.Id=ReceiverId )
where ReceiverType=3 and TransactionType=1;

update ACHTransaction set CompanyName=Name
where ReceiverType=1 and TransactionType=2;

/****** Object:  StoredProcedure [dbo].[GetACHData]    Script Date: 12/01/2017 4:25:49 PM ******/
