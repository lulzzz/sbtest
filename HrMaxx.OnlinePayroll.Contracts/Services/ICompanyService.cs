...
namespace HrMaxx.OnlinePayroll.Contracts.Services
{
	public interface ICompanyService
	{
		...
		CompanyDeduction SaveDeduction(CompanyDeduction deduction, string fullName);
		CompanyWorkerCompensation SaveWorkerCompensation(CompanyWorkerCompensation workerCompensation, string fullName);
		AccumulatedPayType SaveAccumulatedPayType(AccumulatedPayType mappedResource, string fullName);
		CompanyPayCode SavePayCode(CompanyPayCode mappedResource, string fullName);
		...
		CompanyTaxRate SaveCompanyTaxYearRate(CompanyTaxRate mappedResource, string fullName);
