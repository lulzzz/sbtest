...
#Set-ItemProperty $appPoolPath -name processModel -value @{identitytype="vpl\svc_Visz"}
} else {
...
#-- Make sure any old locations using the app pool are recycled --#
Restart-WebItem $appPoolPath
