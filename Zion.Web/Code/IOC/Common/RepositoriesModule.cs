...
namespace HrMaxx.Web.Code.IOC.Common
{
	public class RepositoriesModule : Module
	{
		protected override void Load(ContainerBuilder builder)
		{
			...
			string _userImagePath = HttpContext.Current == null
				? string.Empty
				: HttpContext.Current.Server.MapPath("~/Header/Images/UserImages/");
			...
			namedParameters.Add(new NamedParameter("userimagepath", _userImagePath));
