 ...
 */
   ...
   */
			...
			this.$get = [
				'$$q', '$$asyncCallback', '$rootScope', function($$q, $$asyncCallback, $rootScope) {
 ...
 */
	...
	function $$QProvider() {
		this.$get = [
			'$browser', '$exceptionHandler', function($browser, $exceptionHandler) {
				return qFactory(function(callback) {
...
/* jshint maxlen: 100 */
   ...
   */
		...
		this.$get = [
			'$document', '$parse', '$sceDelegate', function(
 ...
 */
	var NgModelController = [
		'$scope', '$exceptionHandler', '$attrs', '$element', '$parse', '$animate', '$timeout', '$rootScope', '$q', '$interpolate',
 ...
 */
	var ngBindHtmlDirective = [
		'$sce', '$parse', '$compile', function($sce, $parse, $compile) {
			return {
				restrict: 'A',
 ...
 */
	var ngIncludeDirective = [
		'$templateRequest', '$anchorScroll', '$animate', '$sce',
