...
namespace HrMaxx.Web
{
	public static class MiniProfilerPackage
	{
		...
		public static void PreStart()
		{
			...
			List<string> ignoredPaths = MiniProfiler.Settings.IgnoredPaths.ToList();
			ignoredPaths.Add("Glimpse.axd");
			ignoredPaths.Add("signalr");
			MiniProfiler.Settings.IgnoredPaths = ignoredPaths.ToArray();

			IsEnabled = bool.Parse(ConfigurationManager.AppSettings["EnableMiniProfiler"]);
		}
	...
	public class MiniProfilerStartupModule : IHttpModule
	{
		public void Init(HttpApplication context)
		{
			context.BeginRequest += (sender, e) =>
			{
				...
				if (MiniProfilerPackage.IsEnabled) MiniProfiler.Start();
			};
