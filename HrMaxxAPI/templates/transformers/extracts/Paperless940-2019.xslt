<xsl:stylesheet version="1.0" xmlns="urn:schemas-microsoft-com:office:spreadsheet" xmlns:xsl="http://www.w3.org/1999/XSL/Transform"
	...
	<xsl:template match="ExtractResponse">
        ...
        <Column ss:Index="6" ss:StyleID="s119" ss:AutoFitWidth="0" ss:Width="47.25"/>
        ...
        <Row ss:AutoFitHeight="0" ss:Height="66" ss:StyleID="s108">
          <Cell ss:StyleID="s79">
          ...
          <Cell ss:StyleID="s121">
            <Data ss:Type="String">Country Code - (US or Blank equals Domestic)</Data>
          </Cell>
          <Cell ss:StyleID="s67">
        ...
        <Column ss:StyleID="s74" ss:AutoFitWidth="0" ss:Width="105.75"/>
        ...
        <Column ss:StyleID="s120" ss:AutoFitWidth="0" ss:Width="126.75"/>
        <Column ss:StyleID="s74" ss:AutoFitWidth="0" ss:Width="98.25"/>
        <Column ss:StyleID="s74" ss:Width="57"/>
        ...
        <Row ss:StyleID="s104">
          ...
          <Cell ss:StyleID="s101">
            <Data ss:Type="String">Used for Line 10 Workheet Only</Data>
          </Cell>
          <Cell ss:StyleID="s102">
            <Data ss:Type="String">Used for Line 10 Worksheet Only</Data>
          </Cell>
          <Cell ss:StyleID="s99">
            <Data ss:Type="String"> </Data>
          </Cell>
          ...
          <Cell ss:StyleID="s94">
            <Data ss:Type="String">Line 3</Data>
          </Cell>
          <Cell ss:StyleID="s94">
            <Data ss:Type="String">Used for Line 10 Worksheet Only</Data>
          </Cell>
          ...
          <Cell ss:StyleID="s94">
            <Data ss:Type="String">Line 4</Data>
          </Cell>
          <Cell ss:StyleID="s94">
            <Data ss:Type="String">4A</Data>
          </Cell>
          <Cell ss:StyleID="s94">
            <Data ss:Type="String">4B</Data>
          </Cell>
          <Cell ss:StyleID="s94">
            <Data ss:Type="String">4C</Data>
          </Cell>
          <Cell ss:StyleID="s94">
            <Data ss:Type="String">4D</Data>
          </Cell>
          <Cell ss:StyleID="s94">
            <Data ss:Type="String">4E</Data>
          </Cell>
          <Cell ss:StyleID="s93">
          ...
          <Cell ss:StyleID="s118">
            <Data ss:Type="String">For Schedule R Only</Data>
          </Cell>
          <Cell ss:StyleID="s94">
            <Data ss:Type="Number">13</Data>
          </Cell>
          <Cell ss:StyleID="s94">
            <Data ss:Type="String">16A</Data>
          </Cell>
          <Cell ss:StyleID="s94">
            <Data ss:Type="String">16B</Data>
          </Cell>
          <Cell ss:StyleID="s94">
            <Data ss:Type="String">16C</Data>
          </Cell>
          <Cell ss:StyleID="s94">
            <Data ss:Type="String">16D</Data>
          </Cell>
          <Cell ss:StyleID="s103">
            <Data ss:Type="String">Used for either State Abbreviation on Line 1A or Schedule A if multi State</Data>
          </Cell>
          <Cell ss:StyleID="s103">
            <Data ss:Type="String">FUTA Taxable Wages on Line 7 or Schedule A</Data>
          </Cell>
          <Cell ss:StyleID="s103">
            <Data ss:Type="String">Wages for Line 10 Worksheet Only</Data>
          </Cell>
          <Cell ss:StyleID="s103">
            <Data ss:Type="String">Experience Rate for Line 10 Worksheet Only</Data>
          </Cell>
          <Cell ss:StyleID="s103"/>
          <Cell ss:StyleID="s103"/>
          <Cell ss:StyleID="s103"/>
	...
	<xsl:template match="ExtractHost" mode="i940">
			...
			<xsl:variable name="line12a" select="format-number($line7*0.006,'####.00')" />
