<xsl:stylesheet version="1.0"
 ...
 xmlns:html="http://www.w3.org/TR/REC-html40">
  ...
  <WorksheetOptions xmlns="urn:schemas-microsoft-com:office:excel">
   ...
   <Row></Row>
   <xsl:apply-templates select="Hosts/ExtractHost[count(PayChecks/PayCheck)>0]" mode="i941"/>
  </Table>
  <WorksheetOptions xmlns="urn:schemas-microsoft-com:office:excel">
                <PageSetup>
                    <Header x:Margin="0.3" />
 ...
 <Worksheet ss:Name="777777777">
  <Table x:FullColumns="1"
   ...
   <Row></Row>
   <xsl:apply-templates select="Hosts/ExtractHost[count(PayChecks/PayCheck)>0]" mode="i777"/>
  </Table>
  <WorksheetOptions xmlns="urn:schemas-microsoft-com:office:excel">
   <PageSetup>
    <Header x:Margin="0.3"/>
