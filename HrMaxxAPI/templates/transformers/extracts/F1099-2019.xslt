...
<xsl:call-template name="padRight"><xsl:with-param name="data" select="'CORPORATE BENEFITS CORP'"/><xsl:with-param name="count" select="80"/></xsl:call-template>
<xsl:call-template name="padRight"><xsl:with-param name="data" select="'CORPORATE BENEFITS CORP'"/><xsl:with-param name="count" select="80"/></xsl:call-template>
...
<xsl:call-template name="padRight"><xsl:with-param name="data" select="'Monica Contreras'"/><xsl:with-param name="count" select="40"/></xsl:call-template>
...
<xsl:call-template name="padRight"><xsl:with-param name="data" select="'MC.HRMAXX@GMAIL.COM'"/><xsl:with-param name="count" select="50"/></xsl:call-template>
...
<xsl:apply-templates select="ExtractResponse/Hosts/ExtractHost[count(Companies/ExtractCompany/Vendors/CompanyVendor[Amount>0])>0]/HostCompany">
	<xsl:sort data-type="text" select="TaxFilingName"/>
</xsl:apply-templates>
F<xsl:call-template name="padLeft"><xsl:with-param name="data" select="count(ExtractResponse/Hosts/ExtractHost/Companies/ExtractCompany[Vendors/CompanyVendor/Vendor/Type1099='MISC' and Vendors/CompanyVendor/Amount>0])+count(ExtractResponse/Hosts/ExtractHost/Companies/ExtractCompany[Vendors/CompanyVendor/Vendor/Type1099='DIV' and Vendors/CompanyVendor/Amount>0])+count(ExtractResponse/Hosts/ExtractHost/Companies/ExtractCompany[Vendors/CompanyVendor/Vendor/Type1099='INT' and Vendors/CompanyVendor/Amount>0])"/><xsl:with-param name="count" select="8"/></xsl:call-template>
...
<xsl:apply-templates select="." mode="type">
	<xsl:with-param name="vType" select="'MISC'"/>
</xsl:apply-templates>
...
<xsl:if test="count(Vendors/CompanyVendor[Vendor/Type1099='DIV'])>0">
	<xsl:apply-templates select="." mode="type">
		<xsl:with-param name="vType" select="'DIV'"/>
	</xsl:apply-templates>
...
<xsl:if test="count(../Companies/ExtractCompany/Vendors/CompanyVendor[Vendor/Type1099='INT'])>0">
	<xsl:apply-templates select="." mode="type">
		<xsl:with-param name="vType" select="'INT'"/>
	</xsl:apply-templates>
...
<xsl:call-template name="padRight"><xsl:with-param name="data" select="$amCode"/><xsl:with-param name="count" select="16"/></xsl:call-template>
...
<xsl:variable name="mailingAddress" select="translate(substring(CompanyAddress/AddressLine1,1,40),$smallcase,$uppercase)"/>
...
<xsl:call-template name="padRight"><xsl:with-param name="data" select="translate(CompanyAddress/City,$smallcase,$uppercase)"/><xsl:with-param name="count" select="40"/></xsl:call-template><xsl:value-of select="CompanyAddress/StateCode"/>
<xsl:call-template name="padRight"><xsl:with-param name="data" select="translate(concat('',CompanyAddress/Zip,../Contact/Address/ZipExtension),$smallcase,$uppercase)"/><xsl:with-param name="count" select="9"/></xsl:call-template>
...
<xsl:call-template name="padRight"><xsl:with-param name="data" select="' '"/><xsl:with-param name="count" select="258"/></xsl:call-template>
mainCounter
<xsl:call-template name="padRight"><xsl:with-param name="data" select="' '"/><xsl:with-param name="count" select="243"/></xsl:call-template>
<xsl:text>$$n</xsl:text>
<xsl:apply-templates select="../Companies/ExtractCompany/Vendors/CompanyVendor[Vendor/Type1099=$vType and Amount>0]">
	<xsl:sort select="Vendor/Name" data-type="text"/>
</xsl:apply-templates>
</xsl:template>
...
<xsl:choose>
<xsl:when test="Vendor/IndividualSSN!=''">
	<xsl:choose><xsl:when test="starts-with(Vendor/IndividualSSN,'9')">3</xsl:when><xsl:otherwise>2</xsl:otherwise></xsl:choose>
	<xsl:call-template name="padRight"><xsl:with-param name="data" select="translate(Vendor/IndividualSSN,'-','')"/><xsl:with-param name="count" select="9"/></xsl:call-template></xsl:when>
<xsl:otherwise>
	<xsl:choose>
...
<xsl:param name="type"/>
<xsl:choose>
<xsl:when test="$type='MISC'">A</xsl:when>
<xsl:when test="$type='INT'">6</xsl:when>
<xsl:when test="$type='DIV'">1</xsl:when>
</xsl:choose>
</xsl:template>
<xsl:template name="getAmountCode">
<xsl:param name="type"/>
<xsl:choose>
<xsl:when test="$type='MISC'">12345678ABCDE</xsl:when>
<xsl:when test="$type='INT'">12345689ABDE</xsl:when>
<xsl:when test="$type='DIV'">12356789ABCDEFG</xsl:when>
</xsl:choose>
</xsl:template>
</xsl:stylesheet>
