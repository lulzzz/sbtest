...
<xsl:param name="todaydate"/>
	...
	<xsl:param name="month4"/>
	<xsl:param name="month5"/>
	<xsl:param name="month6"/>
	<xsl:param name="month7"/>
	<xsl:param name="month8"/>
	<xsl:param name="month9"/>
	<xsl:param name="month10"/>
	<xsl:param name="month11"/>
	<xsl:param name="month12"/>
