...
<xsl:template match="Accumulation">
	...
	<Report>
		...
		<Fields>
			...
			<xsl:call-template name="FieldTemplate"><xsl:with-param name="name1" select="'empfirstname'"/><xsl:with-param name="val1" select="$empfirstname"/></xsl:call-template>
			<xsl:call-template name="FieldTemplate"><xsl:with-param name="name1" select="'empmiddlename'"/><xsl:with-param name="val1" select="$empmiddlename"/></xsl:call-template>
			<xsl:call-template name="FieldTemplate"><xsl:with-param name="name1" select="'emplastname'"/><xsl:with-param name="val1" select="$emplastname"/></xsl:call-template>
