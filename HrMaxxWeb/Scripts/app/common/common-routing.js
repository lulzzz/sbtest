...
common.config(['$httpProvider', '$routeProvider', '$locationProvider', 'zionAPI', function ($httpProvider, $routeProvider, $locationProvider, zionAPI) {
	...
	$routeProvider.when('/Client/SchedulePayrolls', {
		templateUrl: zionAPI.Web + 'Areas/Client/templates/scheduledpayrolls.html'
	});
	...
	$routeProvider.when('/Client/Receivables', {
		templateUrl: zionAPI.Web + 'Areas/Client/templates/vendorinvoices.html'
	});
