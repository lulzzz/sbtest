common.factory('payrollRepository', [
	...
	function ($http, zionAPI, zionPaths, $q, payrollServer, upload) {
		return {
			...
			deleteSchedulePayroll: function (payroll) {
				var deferred = $q.defer();
				payrollServer.all('DeleteScheduledPayroll').post(payroll).then(function (data) {
					deferred.resolve(data);
				}, function (error) {
					deferred.reject(error);
				});
			...
			UnVoidPayroll: function (payroll) {
				var deferred = $q.defer();
				payrollServer.all('UnVoidPayroll').post(payroll).then(function (data) {
					deferred.resolve(data);
				}, function (error) {
					deferred.reject(error);
				});
			...
			emailPayrollPack: function (payroll) {
				var deferred = $q.defer();
				payrollServer.all('EmailPayrollPack').post(payroll).then(function (data) {
					deferred.resolve(data);
				}, function (error) {
					deferred.reject(error);
				});
			...
			recalculateAccumulations: function (payroll) {
				var deferred = $q.defer();
				payrollServer.all('ReCalculateAccumulations').post(payroll).then(function (data) {
					deferred.resolve(data);
				}, function (error) {
					deferred.reject(error);
				});
